...
namespace MatchController {
  ...
  router.get(MatchAPIConstants.GET_MATCH(), asyncHandler(async (req, resp) => {
  ...
  router.get(MatchAPIConstants.GET_ALL_MATCH_METADATA(), asyncHandler(async (req, resp, next) => {
    try {
  ...
  router.get(MatchAPIConstants.GET_MATCH_METADATA(), asyncHandler(async (req, resp, next) => {
    try {
  ...
  router.put(MatchAPIConstants.ADD_MATCH_METADATA(), RequireRole('Admin'), asyncHandler(async (req, resp) => {
  ...
  router.put(MatchAPIConstants.SELECT_WINNER(), RequireRole('Admin'), asyncHandler(async (req, resp) => {
  ...
  router.put(MatchAPIConstants.FORFEIT(), RequireRole('Admin'), asyncHandler(async (req, resp) => {
  ...
  router.put(MatchAPIConstants.UPDATE_SCORE(), RequireRole('Admin'), asyncHandler(async (req, resp) => {
  ...
  router.put(MatchAPIConstants.UPDATE_STATE(), RequireRole('Admin'), asyncHandler(async (req, resp) => {
  ...
  router.get(MatchAPIConstants.RESET_MATCH(), RequireRole('Admin'), asyncHandler(async (req, resp) => {
    await TournamentManager.instance.reset(req.params.tid, Number(req.params.mid));
    resp.sendStatus(200);
  }));

  router.put(MatchAPIConstants.UPDATE(), RequireRole('Admin'), asyncHandler(async (req, resp) => {
