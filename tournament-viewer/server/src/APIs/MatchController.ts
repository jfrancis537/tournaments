...
namespace MatchController {
  ...
  router.put(MatchAPIConstants.SELECT_WINNER(), async (req,resp) => {
  ...
  router.put(MatchAPIConstants.FORFEIT(), async (req,resp) => {
  ...
  router.put(MatchAPIConstants.UPDATE_SCORE(), async (req, resp) => {
  ...
  router.put(MatchAPIConstants.UPDATE_STATE(), async (req,resp) => {
  ...
  router.put(MatchAPIConstants.UPDATE(), async (req,resp) => {
